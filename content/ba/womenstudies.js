// ============================================================
//  SUGGESTION HUB — BA — Women Studies 
//
...
const BA_WOMENSTUDIES = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Women Studies", type: "pdf", url: "https://drive.google.com/drive/folders/1JJLJAYw7hPLjreTlGYY4o0_-qBuuk1hL"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
