// ============================================================
//  SUGGESTION HUB — BA — Political Science
//
...
//             into this repo, e.g. "files/ba/politicalscience/chapter1.pdf")
// ============================================================

const BA_POLITICALSCIENCE = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Political Science", type: "pdf", url: "https://drive.google.com/drive/folders/1n1MI-cdYLRORnjjeeqmM3XeST14U5A3Q"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
