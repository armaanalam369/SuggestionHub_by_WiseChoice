// ============================================================
//  SUGGESTION HUB — BA — Physical Education 
//
...
const BA_PHYSICALEDUCATION = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Physical Education", type: "pdf", url: "https://drive.google.com/drive/folders/1eXWXVjBx-8tlrYVDtHuDhXMLkWl-MhhB"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
