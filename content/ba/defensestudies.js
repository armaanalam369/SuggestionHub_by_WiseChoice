// ============================================================
//  SUGGESTION HUB — BA — Defense Studies 
//
...
//             into this repo, e.g. "files/ba/english/chapter1.pdf")
// ============================================================

const BA_DEFENSESTUDIES = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Defense Studies", type: "pdf", url: "https://drive.google.com/drive/folders/1X5bD3mmv4MSQF_DfoVOjq3EWyNOqyYt5"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
