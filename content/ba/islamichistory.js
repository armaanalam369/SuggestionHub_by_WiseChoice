// ============================================================
//  SUGGESTION HUB — BA — Islamic History
//
...
//             into this repo, e.g. "files/ba/history/chapter1.pdf")
// ============================================================

const BA_ISLAMICHISTORY = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Islamic History", type: "pdf", url: "https://drive.google.com/drive/folders/1diIpv3N6qjXlaOFZmQMaCc-hfa-IGvlr"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
