// ============================================================
//  SUGGESTION HUB — BA — Film Studies
//
...
const BA_FILMSTUDIES = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Film Studies", type: "pdf", url: "https://drive.google.com/drive/folders/1rQMB5u4aUbE6VLk874XEy4IOoOZJRuMb"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
