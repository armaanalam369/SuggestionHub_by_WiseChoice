...
const BSC_PSYCHOLOGY = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Psychology", type: "pdf", url: "https://drive.google.com/drive/folders/1MugrJdmEKTjwz7Slga-6Zp-bao3xzCHm"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
