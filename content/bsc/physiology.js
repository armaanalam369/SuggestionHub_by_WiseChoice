...
//             into this repo, e.g. "files/ba/chemistry/chapter1.pdf")
// ============================================================

const BSC_PHYSIOLOGY = {
  name: "Physiology",
  icon: "💪",
  examDate: "",
  status: "pending",
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Physiology", type: "pdf", url: "https://drive.google.com/drive/folders/1yxQ5whJGZgIjpvhhrBG-MXc9cXNa2tk5"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
