// ============================================================
//  SUGGESTION HUB — BSC — Anthropology 
//
...
//             into this repo, e.g. "files/ba/botany/chapter1.pdf")
// ============================================================

const BSC_ANTHROPOLOGY = {
  name: "Anthropology",
  icon: "🌿",
  examDate: "",
  status: "pending",
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Anthropology", type: "pdf", url: "https://drive.google.com/drive/folders/1tNAjMsckab-Ra5IP2CAy5021P0wx5W5Q"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
