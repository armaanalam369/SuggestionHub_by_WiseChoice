// ============================================================
//  SUGGESTION HUB — BSC — Mathematics
//
...
//             into this repo, e.g. "files/ba/mathematics/chapter1.pdf")
// ============================================================

const BSC_MATHEMATICS = {
  name: "Mathematics",
  icon: "➗",
  examDate: "",
  status: "pending",
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Mathematics", type: "pdf", url: "https://drive.google.com/drive/folders/1eNx-ODB_fl686KLdN1HoaTqU1-Stng0h"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
