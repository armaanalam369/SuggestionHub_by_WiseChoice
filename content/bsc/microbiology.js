// ============================================================
//  SUGGESTION HUB — BSC — Microbiology 
//
...
const BSC_MICROBIOLOGY = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Microbiology", type: "pdf", url: "https://drive.google.com/drive/folders/1qOgCR3a9FDiKgeq-WTAH3REMT-bnIeYP" }
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
