// ============================================================
//  SUGGESTION HUB — BSC — Biochemistry 
//
...
//             into this repo, e.g. "files/ba/zoology/chapter1.pdf")
// ============================================================

const BSC_BIOCHEMISTRY = {
  name: "Biochemistry",
  icon: "🦠",
  examDate: "",
  status: "pending",
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Biochemistry", type: "pdf", url: "https://drive.google.com/drive/folders/1C2doA6pE4A_tt8mZ4zRZF-PPeWCuqyvk"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
