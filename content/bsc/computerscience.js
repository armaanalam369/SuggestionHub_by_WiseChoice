// ============================================================
//  SUGGESTION HUB — BSC — Computer Science
//
...
//             into this repo, e.g. "files/ba/computerscience/chapter1.pdf")
// ============================================================

const BSC_COMPUTERSCIENCE = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Computer Science", type: "pdf", url: "https://drive.google.com/drive/folders/1PcnazdfkgjXZp7lSrhU0h5HQBr5Ohhci"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
