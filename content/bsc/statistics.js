...
//             into this repo, e.g. "files/ba/physics/chapter1.pdf")
// ============================================================

const BSC_STATISTICS = {
  name: "Statistics",
  icon: "💯",
  examDate: "",
  status: "pending",
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Statistics", type: "pdf", url: "https://drive.google.com/drive/folders/1oJgKoWHd9Rdup9dOwB0hB2w5YdImd8hO"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
