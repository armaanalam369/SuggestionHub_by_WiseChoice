...
//             into this repo, e.g. "files/ba/businesslaw/chapter1.pdf")
// ============================================================
...
const BCOM_COMMERCE = {
  ...
  suggestions: [
    ...
    // { title: "Suggestion — Unit 1", type: "pdf", url: "https://drive.google.com/..." }
       { title: "Suggestion — Commerce", type: "pdf", url: "https://drive.google.com/drive/folders/1I2h2B6kk_uynXzot-wpuX8eZFoMLulLZ"}
  ],
  materials: [
    // Example -- delete or replace this once you add real items:
